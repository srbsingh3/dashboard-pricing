...
export const experiments: Experiment[] = [
  ...
  {
    id: 392,
    name: "FP_SG_MOV_Premium_Brands_Loyal",
    status: "enabled",
    alreadyStarted: true,
    targetGroups: 1,
    variations: 1,
  ...
  {
    id: 903,
    name: "SG_Low_Sensitivity_QSR_Test",
    status: "draft",
    alreadyStarted: false,
    targetGroups: 1,
    variations: 1,
  ...
  {
    id: 267,
    name: "FP_SG_DF_Distance_Tier_Test",
    status: "disabled",
    alreadyStarted: false,
    targetGroups: 6,
    variations: 6,
  ...
  {
    id: 890,
    name: "Low Sensitivity - Lower Brands SG",
    status: "completed",
    alreadyStarted: false,
    targetGroups: 2,
    variations: 2,
  ...
  {
    id: 1089,
    name: "FP_SG_High_Value_Orders_SF_Test",
    status: "enabled",
    alreadyStarted: true,
    targetGroups: 4,
    variations: 2,
    ...
    email: "madonna.ciccone@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
  ...
  {
    id: 1203,
    name: "SG_Peak_Hours_Surge_Pricing",
    status: "enabled",
    alreadyStarted: true,
    targetGroups: 5,
    variations: 4,
    ...
    email: "whitney.houston@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
  ...
  {
    id: 1345,
    name: "Weather Surge - Rainy Days SG",
    status: "disabled",
    alreadyStarted: true,
    targetGroups: 8,
    variations: 3,
    ...
    email: "elton.john@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
    id: 1412,
    name: "FP_SG_Grocery_MOV_Optimization",
    status: "completed",
    alreadyStarted: true,
    targetGroups: 4,
    variations: 4,
    ...
    email: "tina.turner@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
  ...
  {
    id: 1601,
    name: "SG_Late_Night_Premium_Pricing",
    status: "enabled",
    alreadyStarted: true,
    targetGroups: 3,
    variations: 2,
    ...
    email: "stevie.nicks@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  // Page 3
  ...
  {
    id: 1745,
    name: "FP_SG_CBD_Lunch_Rush_Test",
    status: "enabled",
    alreadyStarted: true,
    targetGroups: 5,
    variations: 2,
    ...
    email: "cher.sarkisian@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
  ...
  {
    id: 1879,
    name: "SG_Weekend_Brunch_Elasticity",
    status: "enabled",
    alreadyStarted: true,
    targetGroups: 7,
    variations: 4,
    ...
    email: "celine.dion@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
  ...
  },
  {
    ...
    email: "janet.jackson@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
  ...
  {
    id: 2147,
    name: "SG_Residential_vs_Commercial_SF",
    status: "disabled",
    alreadyStarted: true,
    targetGroups: 6,
    variations: 2,
    ...
    email: "cyndi.lauper@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
  {
  ...
  {
    id: 2281,
    name: "FP_SG_Loyalty_Tier_DF_Discount",
    status: "draft",
    alreadyStarted: false,
    targetGroups: 4,
    variations: 4,
    ...
    email: "barbra.streisand@foodpanda.sg",
    region: "Singapore",
    city: "Singapore",
  },
];
